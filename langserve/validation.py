...
class InvokeRequestShallowValidator(BaseModel):
    ...
    # Make input optional. This enables LangGraph to send an empty input
    # to the tool to continue graph execution.
    input: Optional[Any] = Field(None, description="The input to the runnable.")
    # END LG_MODIFICATION
